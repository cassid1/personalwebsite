...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'connect4driver.data';
      var REMOTE_PACKAGE_BASE = 'connect4driver.data';
          ...
          DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_connect4driver.data');

      };
      Module['addRunDependency']('datafile_connect4driver.data');
   ...
   loadPackage({"files": [{"audio": 0, "end": 8533, "filename": "/connect4black.net", "start": 0}, {"audio": 0, "end": 17065, "filename": "/connect4red.net", "start": 8533}], "remote_package_size": 17065, "package_uuid": "1bae3e01-3bd6-4b79-aff1-f9ead82880d7"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 22352,
    DYNAMIC_BASE = 5265232,
    DYNAMICTOP_PTR = 22192;
...
var wasmBinaryFile = 'connect4driver.wasm';
